                                    ...
                                    TabView(selection: Binding<Int>(
                                        ...
                                        set: { newValue in
                                            guard currentPostIndices.indices.contains(profileIndex),
                                                  newValue < postsForThisProfile.count
                                            else {
...
struct WebView: UIViewRepresentable {
    ...
    class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
        ...
        func webView(_: WKWebView, runJavaScriptAlertPanelWithMessage message: String, initiatedByFrame frame: WKFrameInfo, completionHandler: @escaping () -> Void) {
        ...
        func webView(_: WKWebView, runJavaScriptConfirmPanelWithMessage message: String, initiatedByFrame frame: WKFrameInfo, completionHandler: @escaping (Bool) -> Void) {
        ...
        func webView(_: WKWebView, runJavaScriptTextInputPanelWithPrompt prompt: String, defaultText: String?, initiatedByFrame frame: WKFrameInfo, completionHandler: @escaping (String?) -> Void) {
